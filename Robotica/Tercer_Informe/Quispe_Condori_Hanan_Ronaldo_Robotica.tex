...
\begin{enumerate}
    ...
    \begin{equation}
        ...
        \label{eq:donex2}
    \end{equation}
    De la ecuación (\ref{eq:donex2}) se puede concluir que la componente de regulación esta acotada, adicionalmente a esto se puede afirmar que.
    \begin{equation}
        \begin{split}
